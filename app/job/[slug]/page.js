  ...
  if (loading) {
    return (
      <div className={`min-h-screen ${colors.neutral.background} font-sans`}>
        <Header />
        <div className={`${layout.container} flex justify-center items-center py-20`}>
      ...
      <div className={`min-h-screen ${colors.neutral.background} font-sans`}>
        ...
        <div className={`${layout.container} text-center py-20`}>
          <div className="text-red-500 mb-4">
            ...
            <h3 className={`${typography.h4} ${colors.neutral.textPrimary} mb-2`}>Job not found</h3>
            <p className={`${typography.bodyBase} ${colors.neutral.textSecondary} mb-4`}>
              {error || 'The job you are looking for does not exist.'}
            </p>
            <Link href="/" className={`${components.button.primary} ${components.button.sizes.medium} inline-block`}>
              Back to Jobs
            </Link>
          </div>
        </div>
      ...
      <main className={layout.container}>
        <div className={`${layout.section} py-8`}>
          ...
          <nav className="flex space-x-2 items-center mb-6">
            <Link href="/" className={`${colors.neutral.textMuted} hover:${colors.neutral.textSecondary} ${animations.transition}`}>
            ...
            <span className={`${typography.bodySmall} ${colors.neutral.textSecondary} line-clamp-1`}>
              {job.title}
            </span>
          </nav>
          ...
          <div className="mb-8">
            ...
            <div className={`flex flex-wrap items-center ${spacing.gapSmall} ${typography.bodySmall} ${colors.neutral.textSecondary}`}>
              ...
              <div className={`${components.card.base} ${components.card.padding}`}>
                ...
                <div className="prose prose-slate max-w-none">
                  {job.full_description ? (
                    ...
                    <div className={`${colors.neutral.textSecondary} leading-relaxed whitespace-pre-wrap`}>
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className={spacing.gapMedium}>
                ...
                <div className={`${components.card.base} ${components.card.padding}`}>
                  ...
                  <div className={`${colors.neutral.border} border-t my-6`}></div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        <span className={`flex items-center space-x-1 ${colors.neutral.textSecondary}`}>
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span className={`${typography.bodyBase} font-medium ${colors.neutral.textPrimary}`}>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`${typography.bodyBase} font-medium ${colors.neutral.textPrimary}`}>
                          {job.remote === 'Yes' || job.remote === true ? 'Yes' : 'No'}
                        </span>
                      </div>
                ...
                <div className={`${components.card.base} ${components.card.padding}`}>
                  <div className="text-center">
                    <div className={`${colors.neutral.backgroundSecondary} items-center ${colors.neutral.border} border font-medium ${colors.neutral.textPrimary} rounded inline-block p-2 mb-4`}>
                    ...
                    <p className={`${typography.bodyBase} ${colors.neutral.textSecondary} mb-4`}>
                      Subscribe to receive new job postings that match your interests
                    </p>
        ...
        {(relatedJobs.length > 0 || relatedLoading) && (
          <div className={`${layout.container} mt-16`}>
            <h2 className={`${typography.h2} ${colors.neutral.textPrimary} mb-8`}>
              Related Jobs
            </h2>
