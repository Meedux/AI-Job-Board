        ...
        <div className="relative p-4 sm:p-5">
          <div className="flex items-start gap-4">
            ...
            <div className="relative">
              <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 bg-gray-700/50 border border-gray-600/50 group-hover:border-gray-500/50 transition-all duration-200">
                <Image
                  src={companyLogo}
                  alt={companyName}
                  width={48}
              ...
              <div className="flex items-start justify-between gap-3 mb-2">
                <div className="flex-1 min-w-0">
                  <h3 className={combineClasses(
                    ...
                    "text-base sm:text-lg leading-tight mb-1",
                    "line-clamp-2"
                  )}>
                    {title}
                  </h3>
              ...
              {categories && categories.length > 0 && (
                <div className="flex items-center gap-2 mb-2">
                  {categories.slice(0, 3).map((category, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center px-2.5 py-1 text-xs bg-gray-700/50 text-gray-300 rounded-full border border-gray-600/50 hover:bg-gray-600/50 transition-colors"
                    >
                      #{category}
                    </span>
                  ))}
                  {categories.length > 3 && (
                    <span className="inline-flex items-center px-2.5 py-1 text-xs bg-gray-700/30 text-gray-400 rounded-full border border-gray-600/30">
