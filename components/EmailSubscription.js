  ...
  return (
    <div className={`${components.card.base} ${components.card.padding}`}>
      <div className="text-center mb-6">
        <div className={`inline-flex items-center justify-center w-16 h-16 ${colors.primary[100]} rounded-lg mb-4`}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className={`w-full ${components.button.base} ${isSubmitted ? `${colors.success[600]} text-white` : `${components.button.primary}`} ${components.button.sizes.medium}`}
        >
          {isSubmitted ? (
